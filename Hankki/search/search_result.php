<?php
	...
	while ($data = mysqli_fetch_assoc($result)){
		...
		echo "<tr>";
		echo "<td><a href='recipe_view.php?recipeID=$item_num'><img src='$item_image' width='250' height='250' class='img-responsive'></a></td>";
		echo "<td><a href='recipe_view.php?recipeID=$item_num'>$item_subject</a></td>";
		echo "<td>$item_id</td>";
