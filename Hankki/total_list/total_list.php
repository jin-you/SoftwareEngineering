			...
			<div>					
				...
				<?php while($data = $result->fetch(PDO::FETCH_ASSOC)){?>
					<tr>
						...
						$item_hit=$data['reviewNum'];
						?>
						
						<td><a href="view.php?recipeID=<?=$item_num?>"><?= print "<img src='$item_image' width='250' height='250' class='img-responsive'>";?></a></td>
						<td><a href="view.php?recipeID=<?=$item_num?>"><?= $item_subject?></a></td>
						<td><?= $item_id?></td>
						<td><?= $item_score?></td>
						<td><?= $item_date?></td>
						<td><?= $item_hit?></td>
